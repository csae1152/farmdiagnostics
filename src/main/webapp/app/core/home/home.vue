        ...
        <div class="col-md-9">
            ...
            <div>
                ...
                <div class="alert alert-warning" v-if="!authenticated">
                    <span v-text="$t('global.messages.info.authenticated.prefix')">If you want to see a a demo version please </span>
                    <a class="alert-link" v-on:click="openLogin()" v-text="$t('global.messages.info.authenticated.link')">sign in</a><span v-html="$t('global.messages.info.authenticated.suffix')">
...
<div class="alert alert-warning" v-if="!authenticated">
            <p v-text="$t('home.question')">
                Why you should use Farmdiagnostics....
            </p>
            
            <ul>
                <li>Protect your livestock against diseas.</li>
                <li>Share your devices.</li>
                <li>Analyse And Predict.</li>
                <li>Spread Your Knowledge.</li>
