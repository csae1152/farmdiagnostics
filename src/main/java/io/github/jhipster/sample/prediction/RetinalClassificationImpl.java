...
public class RetinalClassificationImpl {
    private static final Logger log = LoggerFactory.getLogger(RetinalClassificationImpl.class);
    ...
    public void init() throws Exception{
        ...
        log.info("**************** Retinal Image Analysis finished ********************");
    }
